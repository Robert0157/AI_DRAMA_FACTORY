...
| VEO 無浮水印路徑（GATE 0） | Flow 手動匯出預檢（CEO 操作卡 2026-09-13） | **執行中**（匯出即無可見浮水印方可入線；帶水印僅作草稿） |
...
| 5 | VEO 無浮水印路徑驗證（Flow 設定／付費 API 實測） | 驗證 | **GATE 0 操作卡已交付（2026-09-13）；CEO 手動執行中**——落點 `CEO/02_素材與CP-D/VEO_download/` |
...
| 10 | 雙線 CEO 控台（UI 完善提案：唯讀總覽／素材池／待決中心） | 程式 | **待 CEO 圈選**（`CEO/04_架構檢視/CEO控台UI完善提案_v1.md`） |
